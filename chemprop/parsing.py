...
def add_predict_args(parser: ArgumentParser):
    ...
    parser.add_argument('--preds_path', type=str,
                        ...
                        default='test_pred')
    parser.add_argument('--preds_stat_path', type=str,
                        help='Path to CSV file where the predictoins statistics (mae, mse, r2) will be saved',
                        default='test_pred_stat')
    ...
    # parser.add_argument('--add_temp', action='store_true', default=False,
    #                     help='Use temperature or not')
...
def add_train_args(parser: ArgumentParser):
    ...
    parser.add_argument('--undirected', action='store_true', default=False,
                        help='Undirected edges (always sum_5_CV the two relevant bond vectors)')
    ...
    parser.add_argument('--reaction_agg_method', choices=['sum', 'concat'], default='sum',
                        help='Specify the aggregate method')
