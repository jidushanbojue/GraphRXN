...
from chemprop.data.data import ReactionDataset
from chemprop.nn_utils import compute_gnorm, compute_pnorm, NoamLR


def train(model: nn.Module,
          data: Union[ReactionDataset, List[ReactionDataset]],
          loss_func: Callable,
          optimizer: Optimizer,
    ...
    for i in trange(0, num_iters, iter_size):
        ...
        if i + args.batch_size > len(data):
            break
        mol_batch = ReactionDataset(data[i:i + args.batch_size])
