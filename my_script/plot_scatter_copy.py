...
if __name__ == '__main__':
    for func in ['concat', 'sum']:
        fnames = glob(f'/home/baiqing/PycharmProjects/GraphRXN/result/Buchwald/{func}_*_tsne')
        for fname in fnames:
            ...
            info = {
                'name': f'Buchwald GraphRXN-{func} of fold ' + i,
            ...
            make_plot(preds_df['Output'], preds_df['pred_0'], info['RMSE'], info['r2_score'], info['MAE'], info['name'], save_path)
